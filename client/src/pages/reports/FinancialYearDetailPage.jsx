...
export default function FinancialYearDetailPage() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      setLoading(true);
      try {
        const params = withReportScope(cleanFilterParams({ financialYear, company, merType }), scope);
  ...
  const runExport = async (format) => {
    ...
    try {
      ...
      await runMonthlyReportExport({ params, format, filename });
    } finally {
    ...
    <div className="w-full max-w-[90rem] mx-auto">
      ...
      <div className="dashboard-grid-4 mb-4">
        <StatCard
          ...
          iconBg="bg-blue-100"
          accent="bg-blue-500"
          info={EXPENSES_DETAIL_INFO.netExpense}
          icon={
        ...
        <StatCard
          ...
          info={EXPENSES_DETAIL_INFO.gstPaid}
          icon={
        ...
        <StatCard
          ...
          info={EXPENSES_DETAIL_INFO.tdsDeducted}
          icon={
        ...
        <StatCard
          ...
          info={EXPENSES_DETAIL_INFO.grossExpense}
          icon={
