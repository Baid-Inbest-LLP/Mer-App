...
export default function ReportSummaryStatCards({
  ...
  summary,
  showCount = false,
  /** When true, Gross uses cash-paid (monthly overview). Detail/customized use invoice gross. */
  cashGross = false,
}) {
  const gridClass = showCount ? 'dashboard-grid-5' : 'dashboard-grid-4';
  const info = cashGross ? EXPENSES_SUMMARY_INFO : EXPENSES_DETAIL_INFO;
