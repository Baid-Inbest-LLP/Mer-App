  ...
  return (
    <div className="card overflow-hidden">
      <div className="px-6 py-4 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
        ...
        <Link to="/entries" className="text-base text-primary-700 font-semibold hover:underline">
          View all
        </Link>
      </div>
      <div className="divide-y divide-gray-50">
        ...
        {recent.map((entry) => (
          ...
          >
            ...
            <div className="text-right flex items-center gap-3 shrink-0 ml-3">
              <div>
                <p className="text-sm font-bold text-gray-800">{formatCurrency(entry.grossAmount)}</p>
