  ...
  useEffect(() => {
    ...
    class App {
      ...
      hasWebGLContext() {
        ...
        return Boolean(gl && typeof gl.getContextAttributes === 'function' && gl.getContextAttributes());
      }

      initPasses() {
        if (!this.hasWebGLContext() || !this.composer) return;
      ...
      init() {
        // StrictMode remount can resolve loadAssets after dispose(); skip dead instances.
        if (this.disposed || !this.hasWebGLContext()) return;
